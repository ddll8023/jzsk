 ...
 */
@Data
@Schema(name = "组织机构更新请求", description = "更新组织机构信息的请求参数")
public class OrganizationUpdateDTO {

    @Schema(description = "组织机构ID", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "组织机构ID不能为空")
    private Long id;

    @Schema(description = "组织机构名称", example = "希望村组织部", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @Size(max = 255, message = "组织机构名称长度不能超过255个字符")
    private String organizationName;

    @Schema(description = "组织机构代码", example = "421343", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @Size(max = 255, message = "组织机构代码长度不能超过255个字符")
    private String organizationCode;

    @Schema(description = "行政区划名称", example = "湖北省随州市", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(description = "法人代表", example = "张三", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(description = "主要职能", example = "组织希望村设备检查活动", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
