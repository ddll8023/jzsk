 ...
 */
@Data
@Schema(name = "养护记录创建请求", description = "创建新的养护记录")
public class MaintenanceRecordsCreateDTO {

    @Schema(description = "工程名称", example = "荆竹水库水位监测子系统", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "工程名称不能为空")
    @Size(max = 255, message = "工程名称长度不能超过255个字符")
    private String name;

    @Schema(description = "工程代码", example = "123545689", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "工程代码不能为空")
    ...
    @Schema(description = "负责人", example = "李四", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "开始维护时间", example = "2025-06-05 05:07:59", requiredMode = Schema.RequiredMode.REQUIRED)
