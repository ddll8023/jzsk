...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "监测站点创建请求", description = "创建新监测站点的请求参数")
public class MeasuringStationCreateDTO {
    ...
    @Schema(description = "备注", example = "新建监测站点", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String note;
}
