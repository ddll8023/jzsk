...
public class DeviceMonitorController {
     ...
     * 获取GNSS设备状态
     */
    @Operation(summary = "获取GNSS设备状态", description = "查询GNSS地表位移设备的已到报/未到报/采集异常状态")
     ...
     * 获取雨水情设备状态
     */
    @Operation(summary = "获取雨水情设备状态", description = "查询雨水情设备的已到报/未到报/采集异常状态")
    @ApiResponse(responseCode = "200", description = "成功")
    @GetMapping("/rain")
     ...
     * 获取渗流渗压设备状态
     */
    @Operation(summary = "获取渗流渗压设备状态", description = "查询渗流渗压设备的已到报/未到报/采集异常状态")
    @ApiResponse(responseCode = "200", description = "成功")
    @GetMapping("/seepage")
     ...
     * 权限：登录即可访问
     */
    @Operation(summary = "分页查询历史到报情况", description = "分页查询设备到报情况记录，支持按设备类型、到报状态、处理状态、关键词、时间范围筛选")
     ...
     * 删除到报情况记录
     */
    @Operation(summary = "删除到报情况记录", description = "删除指定到报情况记录及其关联的事件明细（物理删除）")
    @ApiResponse(responseCode = "200", description = "删除成功")
    @PostMapping("/fault-record/delete")
    public ResponseEntity<ApiResult<Void>> deleteFaultRecord(
            @Parameter(description = "到报情况记录删除请求", required = true, example = "{\"id\": 1}")
