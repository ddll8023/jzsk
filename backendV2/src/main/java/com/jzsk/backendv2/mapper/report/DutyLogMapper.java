...
public interface DutyLogMapper {
     ...
     * @return 值班日志实体
     */
    DutyLogEntity selectById(Long id);
     ...
     * @return 值班日志列表
     */
    List<DutyLogEntity> selectPage(DutyLogPageQueryDTO queryDTO, long offset, long size);
     ...
     * @return 总数
     */
    long countPage(DutyLogPageQueryDTO queryDTO);
}
