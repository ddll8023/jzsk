...
public class DictDetailServiceImpl implements DictDetailService {
    ...
    public DictDetailVO create(DictDetailCreateDTO request) {
        ...
        String label = normalizeRequiredText(request.getLabel(), "字典标签不能为空");
        ...
        entity.setValue(normalizeRequiredText(request.getValue(), "字典值不能为空"));
    ...
    public DictDetailVO update(DictDetailUpdateDTO request) {
        ...
        existing.setValue(normalizeRequiredText(request.getValue(), "字典值不能为空"));
