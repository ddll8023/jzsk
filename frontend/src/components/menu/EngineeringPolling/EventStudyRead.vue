  ...
  <div id="div1">
    <div id="bread">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="padding-top:5px; padding-left:10px">
        ...
        <el-breadcrumb-item :to="{ path: '/home/eventstudyread' }">事件中心</el-breadcrumb-item>
      </el-breadcrumb>
    </div>

    <div id="div-header2">
      <span style="align-self:center; margin-left:20px;font-size:15px">上报时间：</span>
      <el-date-picker v-model="dataselect" type="datetimerange" range-separator="-" start-placeholder="开始日期"
        end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss" align="right" style="align-self:center;"
        @change="getESListDateEvent" @clear="getESListDateEvent">
      </el-date-picker>


      <span style="align-self:center; margin-left:20px;font-size:15px">事件状态：</span>
      <el-select v-model="eventselect" clearable placeholder="请选择" style="align-self:center;"
        @change="getESListDateEvent" @clear="getESListDateEvent">
        <el-option v-for="item in eventStatus" :key="item.value" :label="item.label" :value="item.value">
        </el-option>
      </el-select>

      <download-excel class="export-excel-wrapper" :data="ESList" :fields="json_fields" name="事件中心数据.xls"
    ...
    <div id="div-main">
      <el-table :data="ESList" border stripe style="width: 100%" height="100%" v-loading="loading"
    ...
    <!-- 新增对话框 -->
    <el-dialog title="新增预警信息" :visible.sync="addDialogVisible" width="40%" @close="addDialogClosed" center
      :close-on-press-escape="false">
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" size="small">
        <el-row :gutter="20">
          <el-col :span="12">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="上报时间:" prop="time">
              ...
              <el-date-picker v-model="addForm.time" type="datetime" placeholder="选择上报时间" align="right"
                :picker-options="pickerOptions" value-format="yyyy-MM-dd HH:mm:ss" :style="{ width: '100%' }">
              </el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog :visible.sync="importDialogVisible" width="800px" :modal="false" :close-on-press-escape="false"
      ...
      <el-upload class="upload-demo" drag ref="upload" accept=".xlsx,.xls" name="file"
        action="/events/import-excel" :file-list="fileList" :auto-upload="false"
        :on-change="fileChange" :on-remove="handleRemove" :before-upload="beforeUpload" :http-request="httpRequest"
        multiple>
