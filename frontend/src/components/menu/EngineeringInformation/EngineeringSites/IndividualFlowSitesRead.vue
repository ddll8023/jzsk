  ...
  <div id="div1">
    <div id="bread">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="padding-top: 5px; padding-left: 10px">
        ...
        <el-breadcrumb-item :to="{ path: '/home/individualflowsites' }">单独流量站点</el-breadcrumb-item>
      </el-breadcrumb>
    </div>

    <div id="div-header1">
      <div style="align-self:center;margin-left:10px">
        <el-input placeholder="请输入单独流量站点名搜索" v-model="input" class="input-with-select" clearable @clear="getIFSList">
          <el-button slot="append" icon="el-icon-search" @click="searchIFS"></el-button>
        </el-input>
      </div>
    ...
    <div id="div-main">
      <el-table :data="IFSList" border stripe height="100%" style="width: 100%"
    ...
    <!-- 新增对话框 -->
    <el-dialog title="新增单独流量站点" :visible.sync="addDialogVisible" width="800px" @close="addDialogClosed" center
    ...
    <!-- 编辑对话框 -->
    <el-dialog title="编辑单独流量站点" :visible.sync="editDialogVisible" width="800px" @close="editDialogClosed" center
      :close-on-press-escape="false" :close-on-click-modal="false">
    ...
    <el-dialog :visible.sync="importDialogVisible" width="800px" :modal="false" :close-on-press-escape="false"
      ...
      <el-upload class="upload-demo" drag ref="upload" accept=".xlsx,.xls" name="file"
        action="/individual-flow-sites/import-excel" :file-list="fileList"
        :auto-upload="false" :on-change="fileChange" :on-remove="handleRemove" :before-upload="beforeUpload"
    ...
    <!-- 导出表格 -->
    <el-table id="table" :data="AllIFSList" border stripe height="100%" style="width: 100%;display:none;"
      :header-cell-style="{ background: '#cfe2f3', color: '#606266' }">
      <el-table-column type="index" label="序号" width="60px" align="center" :index="table_index">
      </el-table-column>
      ...
      <el-table-column prop="measuringStationsElements" label="测站要素" align="center">
      </el-table-column>
      ...
      <el-table-column label="预警指标范围" class="column" align="center">
        <el-table-column prop="upUpLimit" label="上上限" width="120" align="center">
        </el-table-column>
        <el-table-column prop="upLimit" label="上限" width="120" align="center">
        </el-table-column>
        <el-table-column prop="lowLimit" label="下限" width="120" align="center">
        </el-table-column>
        <el-table-column prop="lowerLimit" label="下下限" width="120" align="center">
        </el-table-column>
      </el-table-column>
    ...
    <!-- 导出数据模板 -->
    <el-table id="tableFormwork" :data="ExampleIFS" border stripe height="100%" style="width: 100%;display:none;"
      :header-cell-style="{ background: '#cfe2f3', color: '#606266' }">
      <el-table-column type="index" label="序号" width="60px" align="center" :index="table_index">
      </el-table-column>
      <el-table-column prop="name" label="流量测站名称" align="center">
