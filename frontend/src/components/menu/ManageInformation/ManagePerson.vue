<template>
  <div id="div1">
    <div id="div-header">
      ...
      <el-button type="primary" round icon="el-icon-plus" style="margin-left:auto; align-self: center;margin-right:10px"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="职位:" prop="position">
              <el-select v-model="addForm.position" clearable placeholder="请选择" style="align-self:center;">
                <el-option v-for="item in zhiweiList" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
    ...
    <el-dialog title="编辑人员信息" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed" center
      ...
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="150px" class="demo-ruleForm"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="职位:" prop="position">
              <el-select v-model="editForm.position" clearable placeholder="请选择" style="align-self:center;">
                <el-option v-for="item in zhiweiList" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async getAllZhiweis() {
      ...
      this.zhiweis = res.data
      this.zhiweiList = this.zhiweis.map(zhiwei => ({
        value: zhiwei,
        label: zhiwei
      }))
    },
    ...
    async getAllSexs() {
      ...
      this.sexs = res.data
      this.sexList = this.sexs.map(sex => ({
        value: sex,
        label: sex
      }))
    },
