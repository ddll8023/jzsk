  ...
  <div id="div1">
    <div id="bread">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="padding-top:5px; padding-left:10px">
        ...
        <el-breadcrumb-item :to="{ path: '/home/manageoraganization' }">管理机构信息</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
  ...
  data() {
    return {
      ...
      addFormRules: {
        ...
        agencySpecifications: [
          { required: true, message: '请输入机构规格', trigger: 'blur' }
        ],
        subordinateRelations: [
          { required: true, message: '请输入隶属关系', trigger: 'blur' }
        ],
        institutionalType: [
          { required: true, message: '请输入机构类型', trigger: 'blur' }
        ],
        mainFunction: [
          { required: true, message: '请输入主要职能', trigger: 'blur' }
        ],
        approveContent: [
          { required: true, message: '请输入主要审判内容', trigger: 'blur' }
        ],
        ...
        whetherReform: [
          { required: true, message: '请输入是否施行水务改革', trigger: 'blur' }
        ]
      },
      //查询到的信息对象
      editForm: {},
