    ...
    <div id="main-body">
      ...
      <div id="main-body-main">
        <el-table :data="VCList" border stripe style="width: 100%"
          ...
          <!-- <el-table-column prop="village" label="次地点" align="center">
          </el-table-column> -->
    ...
    <el-dialog title="新增摄像头" :visible.sync="addDialogVisible" width="600px" @close="addDialogClosed" center
      ...
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="80px" size="small">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="次地点:" prop="village">
              <el-select v-model="addForm.village" clearable placeholder="请选择" style="align-self:center;">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="次地点:" prop="village">
              ...
              <el-select v-model="editForm.village" clearable placeholder="请选择" style="align-self:center;">
                <el-option v-for="item in villageList" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async getVillageList() {
      ...
      this.villageList = this.villages.map(village => ({
        value: village,
        label: village
      }))
    },
