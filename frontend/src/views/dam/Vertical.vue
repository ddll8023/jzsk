      ...
      <el-col :span="24">
        <el-card class="table-card" shadow="never">
          ...
          <el-table 
            ...
            <el-table-column prop="yaxisDisplacement" label="垂直位移(mm)" align="center" />
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      try {
        const res = await axios.get('/vertical-displacement')
    ...
    updateChart() {
      ...
      const yData = data.map(item => Number(item.yaxisDisplacement))
