<template>
  ...
  <div class="min-h-full bg-gray-50 p-6 lg:p-8">
    <!-- 页面标题 -->
    <header class="mb-8">
      <h1 class="text-2xl font-bold text-gray-900 tracking-tight">值班日志管理</h1>
      <p class="mt-1 text-sm text-gray-500">记录和管理日常值班日志信息</p>
    </header>
 ...
 * 值班日志页面
 * 功能：值班日志的增删改查
 * 依赖组件：DutyLogQueryPanel, DutyLogTable, DutyLogModal
 * 遵循原则：KISS, YAGNI, SOLID
 */
import { ref, onMounted } from 'vue'
import { useDutyLog } from '@/composables/useDutyLog'
import Card from '@/components/basic/Card.vue'
import DutyLogQueryPanel from '@/components/business/report/DutyLogQueryPanel.vue'
import DutyLogTable from '@/components/business/report/DutyLogTable.vue'
import DutyLogModal from '@/components/business/report/DutyLogModal.vue'
